...
The *wkt* function in the raster package can be used to generate wkts, or functionality
in the sf and sp packages (see examples below):
* raster: raster::wkt()
* sf package: cat(sf::st_crs(4326)$wkt, "\n")
* sp package: cat(sp::wkt(sp::CRS(SRS_string = "EPSG:4326")), "\n") -- if rgdal is build against PROJ >= 6 and GDAL >= 3
...
# other ways to access wkts
sp::CRS(crs_attributes$proj)
...
global_attributes <- list(
    ...
    grid = 'WGS84',
    grid_label = "gn",
    nominal_resolution = "10 km", # calculated with function calculate_nominal_resolution
...
* variantLabel – Variant of the GCM used (e.g. r1i1p1 (CMIP5 format), r1i1p1f1 (CCMIP6 format))
